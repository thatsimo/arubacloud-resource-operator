...
var _ = Describe("09-ComputeWithElasticIP", Ordered, func() {
	const (
		projectName      = "aruba-test-compute-eip"
		vpcName          = "aruba-test-compute-eip"
		sgName           = "aruba-test-compute-eip"
		ruleName         = "aruba-test-compute-eip"
		subnetName       = "aruba-test-compute-eip"
		blockStorageName = "aruba-test-compute-eip"
		keyPairName      = "aruba-test-compute-eip"
		cloudServerName  = "aruba-test-compute-eip"
		elasticIPName    = "aruba-test-compute-eip"
		namespace        = "default"
	...
	It("should create CloudServer with ElasticIP", func(ctx SpecContext) {
		cloudServerYAML, err := utils.LoadSampleManifest("arubacloud.com_v1alpha1_cloudserver_with_elasticip.yaml", map[string]string{
			...
			"__BOOT_VOLUME_NAME__":      blockStorageName,
